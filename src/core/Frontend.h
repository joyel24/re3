...
#define STATS_TOP_MARGIN 75.0f
#define STATS_TOP_DIMMING_AREA_LENGTH (128.0f - STATS_TOP_MARGIN)
#define STATS_BOTTOM_DIMMING_AREA_LENGTH 55.0f
#define STATS_PUT_BACK_TO_BOTTOM_Y 50.0f
#define STATS_RATING_X 50.0f
#define STATS_RATING_Y 40.0f
...
enum eMenuScreen
{
	...
	MENUPAGE_CHOOSE_LOAD_SLOT = 7,
	MENUPAGE_CHOOSE_DELETE_SLOT = 8,
	MENUPAGE_NEW_GAME_RELOAD = 9,
	MENUPAGE_LOAD_SLOT_CONFIRM = 10,
	MENUPAGE_DELETE_SLOT_CONFIRM = 11,
	MENUPAGE_NO_MEMORY_CARD = 12, // hud adjustment page in mobile
	MENUPAGE_LOADING_IN_PROGRESS = 13,
	MENUPAGE_DELETING_IN_PROGRESS = 14,
	MENUPAGE_PS2_LOAD_FAILED = 15,
	MENUPAGE_DELETE_FAILED = 16,
	MENUPAGE_DEBUG_MENU = 17,
	MENUPAGE_MEMORY_CARD_DEBUG = 18,
	MENUPAGE_MEMORY_CARD_TEST = 19,
	MENUPAGE_MULTIPLAYER_MAIN = 20,
	MENUPAGE_PS2_SAVE_FAILED = 21,
	MENUPAGE_PS2_SAVE_FAILED_2 = 22,
	MENUPAGE_SAVE = 23,
	MENUPAGE_NO_MEMORY_CARD_2 = 24,
	MENUPAGE_CHOOSE_SAVE_SLOT = 25,
	MENUPAGE_SAVE_OVERWRITE_CONFIRM = 26,
	MENUPAGE_MULTIPLAYER_MAP = 27,
	MENUPAGE_MULTIPLAYER_CONNECTION = 28,
	MENUPAGE_MULTIPLAYER_FIND_GAME = 29,
	MENUPAGE_MULTIPLAYER_MODE = 30,
	MENUPAGE_MULTIPLAYER_CREATE = 31,
	MENUPAGE_MULTIPLAYER_START = 32,
	MENUPAGE_SKIN_SELECT_OLD = 33,
	MENUPAGE_CONTROLLER_PC = 34,
	MENUPAGE_CONTROLLER_PC_OLD1 = 35,
	MENUPAGE_CONTROLLER_PC_OLD2 = 36,
	MENUPAGE_CONTROLLER_PC_OLD3 = 37,
	MENUPAGE_CONTROLLER_PC_OLD4 = 38,
	MENUPAGE_CONTROLLER_DEBUG = 39,
	MENUPAGE_OPTIONS = 40,
	MENUPAGE_EXIT = 41,
	MENUPAGE_SAVING_IN_PROGRESS = 42,
	MENUPAGE_SAVE_SUCCESSFUL = 43,
	MENUPAGE_DELETING = 44,
	MENUPAGE_DELETE_SUCCESS = 45,
	MENUPAGE_SAVE_FAILED = 46,
	MENUPAGE_LOAD_FAILED = 47,
	MENUPAGE_LOAD_FAILED_2 = 48,
	MENUPAGE_FILTER_GAME = 49,
	MENUPAGE_START_MENU = 50,
	MENUPAGE_PAUSE_MENU = 51,
	MENUPAGE_CHOOSE_MODE = 52,
	MENUPAGE_SKIN_SELECT = 53,
	MENUPAGE_KEYBOARD_CONTROLS = 54,
	MENUPAGE_MOUSE_CONTROLS = 55,
	MENUPAGE_MISSION_RETRY = 56,
