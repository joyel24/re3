...
CMenuManager::DrawFrontEndNormal()
{
	...
	if (curBottomBarOption != -1) {
		...
		if( !bottomBarActive )
		{
			...
			CSprite2d::DrawRect(
				CRect(xpos+MENU_X_LEFT_ALIGNED(82.0f), ypos+SCREEN_SCALE_Y(407.0f), xpos+MENU_X_LEFT_ALIGNED(82.0f)+MENU_X_LEFT_ALIGNED(432.0f), ypos+SCREEN_SCALE_Y(408.0f)+SCREEN_SCALE_Y(17.0f)),
				shadow);
			CSprite2d::DrawRect(
				CRect(xpos+MENU_X_LEFT_ALIGNED(82.0f), ypos+SCREEN_SCALE_Y(407.0f),xpos+MENU_X_LEFT_ALIGNED(82.0f)+MENU_X_LEFT_ALIGNED(432.0f), ypos+SCREEN_SCALE_Y(408.0f)+SCREEN_SCALE_Y(4.0f)),
				green);
		}
