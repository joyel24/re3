...
CMenuManager::DrawFrontEndNormal()
{
	...
	RwRenderStateSet(rwRENDERSTATEVERTEXALPHAENABLE, (void*)TRUE);
	m_aFrontEndSprites[FE2_MAINPANEL_UL].Draw(CRect(MENU_X_LEFT_ALIGNED(0.0f) - 1.0f, 0.0f, (SCREEN_WIDTH / 2) + 1.0f, (SCREEN_HEIGHT / 2) + 1.0f), CRGBA(255, 255, 255, 255));
	m_aFrontEndSprites[FE2_MAINPANEL_UR].Draw(CRect((SCREEN_WIDTH / 2) - 1.0f, 0.0f, MENU_X_RIGHT_ALIGNED(0.0f) + 1.0f, (SCREEN_HEIGHT / 2) + 1.0f) , CRGBA(255, 255, 255, 255));
	m_aFrontEndSprites[FE2_MAINPANEL_DL].Draw(CRect(MENU_X_LEFT_ALIGNED(0.0f) - 1.0f, (SCREEN_HEIGHT / 2) - 1.0f, (SCREEN_WIDTH / 2) + 1.0f, SCREEN_HEIGHT), CRGBA(255, 255, 255, 255));
	m_aFrontEndSprites[FE2_MAINPANEL_DR].Draw(CRect((SCREEN_WIDTH / 2) - 1.0f, (SCREEN_HEIGHT / 2) - 1.0f, MENU_X_RIGHT_ALIGNED(0.0f) + 1.0f, SCREEN_HEIGHT), CRGBA(255, 255, 255, 255));
